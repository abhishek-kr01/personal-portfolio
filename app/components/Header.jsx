...
function Header() {
  return (
    <section className="w-11/12 max-w-3xl text-center mx-auto min-h-screen flex flex-col items-center justify-center gap-5">
      ...
      <motion.h3
        ...
        className="flex items-center gap-2 text-xl sm:text-2xl md:text-3xl font-Ovo"
      >
        Hi, I’m Abhishek Kumar
        <Image src={assets.hand_icon} alt="Waving hand" className="w-5" />
      </motion.h3>
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 mt-6">
        ...
        <motion.a
          ...
          href="/Abhishek.pdf"
          download
          className="px-8 py-3 rounded-full border border-gray-500 flex items-center gap-2 hover:scale-105 transition"
        >
          Download Resume
          <Image
            src={assets.download_icon}
