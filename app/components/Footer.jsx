  ...
  return (<footer className="mt-20">
    ...
    <div className="text-center">
      ...
      <p className="text-sm text-gray-600 dark:text-white/60 mb-3">
        Founding Engineer • Backend Systems • AI Applications
      </p>
    ...
    {/* Bottom Section */}
    <div className="text-center sm:flex items-center justify-between border-t border-gray-300 dark:border-white/20 mx-4 sm:mx-[10%] mt-12 py-6">
      <p className="text-sm sm:text-base text-gray-600 dark:text-white/70">
        © {year} Abhishek Kumar. Built with Next.js & Tailwind CSS.
      </p>
