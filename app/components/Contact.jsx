...
//         I'm always open to discuss new opportunities, collaborations, or tech
...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    try {
      ...
      // keep message visible briefly, then clear "sending" state
  ...
  return (
    ...
    >
      ...
      >
        Have a backend project or hiring need? I’m open to roles in{" "}
        <strong>Java Spring Boot</strong>, <strong>Microservices</strong>, or
        full-stack development. Fill out the form below or contact me directly:
        <br />
        <a
      ...
      >
        ...
        <motion.textarea
          ...
          className="w-full p-4 outline-none border-[0.5px] border-gray-400 rounded-md bg-white mb-6 dark:bg-darkHover/30 dark:border-white/90"
          rows="6"
          placeholder="Message (briefly describe your need)"
          required
          name="message"
          aria-label="Message"
        ></motion.textarea>
